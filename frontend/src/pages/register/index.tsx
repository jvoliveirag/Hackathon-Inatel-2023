                            ...
                            <div className="login-form-card rounded-lg shadow-lg p-6">
                                <form method="POST">
                                    <div className="login-form-inputs flex flex-col gap-1">
                                        ...
                                        <h1 className='flex justify-center font-bold text-2xl text-left text-black py-2'>Faça seu cadastro</h1>
                                        ...
                                        <button type="submit" className='text-black mt-4 rounded-3xl h-10 text-xl bg-green-400 font-bold hover:bg-black hover:text-white'>Criar conta</button>
                                    </div>
                                </form>
                            </div>
                        </div>
